...
public class PicUtil {
     ...
     * @return 返回压缩后图片的存放路径
     */
    public static void saveBitmap(String path, String fileName, int attachSize, OnSaveSuccessListener onSaveSuccessListener) {
...
//        String[] pixel = attachPixel.split("/");
        Bitmap bitmap = decodeSampledBitmapFromPath(path, 1440, 2560);
        ...
        while (baos.toByteArray().length / 1024 > attachSize) {
